...
class Config:
    ...
    def __init__(self):
        ...
        # Database Configuration - Use Render's persistent storage
        self.DATABASE_NAME = '/tmp/monster_trading_bot.db' if 'RENDER' in os.environ else 'monster_trading_bot.db'
